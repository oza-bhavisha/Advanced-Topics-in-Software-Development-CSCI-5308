        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if (student instanceof ScholarshipEligibility) {
                        ((ScholarshipEligibility) student).printScholarshipEligibility();
                    } else {
                        System.out.println("Invalid option for this student type.");
                    }
                    break;
                case 5:
                    if (student instanceof ResearchTopic) {
                        ((ResearchTopic) student).printResearchTopic();
                    } else {
                        System.out.println("Invalid option for this student type.");
                    }
                    break;
